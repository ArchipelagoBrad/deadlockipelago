...
## Poptracker 
[Deadlockipelago Poptracker](https://github.com/GreenestJ/deadlockipelago-poptracker) Now Available (V0.1 Only has manual hero tracking currently)
...
| **Spirits to Unlock Final Character** | Number of Spirits you must collect before your final character unlocks. Max is **three less** than the Spirits-to-Win cap for the same mode (those three hero-win checks require this many Spirits first and may contain Spirits). Used when Goal Type is Win with Character. |
